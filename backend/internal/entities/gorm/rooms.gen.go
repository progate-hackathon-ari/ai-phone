...
func newRoom(db *gorm.DB, opts ...gen.DOOption) room {
	...
	_room.RoomID = field.NewString(tableName, "room_id")
	_room.ExtraPrompt = field.NewString(tableName, "extra_prompt")
	_room.IsStarted = field.NewBool(tableName, "is_started")
	_room.GameSize = field.NewInt32(tableName, "game_size")
	_room.CurrentGame = field.NewInt32(tableName, "current_game")
...
type room struct {
	...
	ALL         field.Asterisk
	RoomID      field.String
	ExtraPrompt field.String
	IsStarted   field.Bool
	GameSize    field.Int32
	CurrentGame field.Int32
...
func (r *room) updateTableName(table string) *room {
	...
	r.ExtraPrompt = field.NewString(table, "extra_prompt")
	r.IsStarted = field.NewBool(table, "is_started")
	r.GameSize = field.NewInt32(table, "game_size")
	r.CurrentGame = field.NewInt32(table, "current_game")
...
func (r *room) fillFieldMap() {
	...
	r.fieldMap["extra_prompt"] = r.ExtraPrompt
	r.fieldMap["is_started"] = r.IsStarted
	r.fieldMap["game_size"] = r.GameSize
	r.fieldMap["current_game"] = r.CurrentGame
}
